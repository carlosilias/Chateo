              ...
              <main id="main" class="col-xl-9">
                ...
                <div class="mad-products item-col-3">
                  ...
                  <div class="mad-col">
                    ...
                    <div class="mad-product">
                      <figure class="mad-product-image">
                        <img src="img/comida/hamburguesa-pollo1.png" alt="">
                      </figure>
                      <!-- product-desc -->
                      <div class="mad-product-description">
                        <h4 class="mad-product-title">Burger Pollo</h4>
                        <p>125 pollo, verduras, salsas de la casa, queso americano, papas.</p>
                      </div>
                      <!--/ product-desc -->
                      <div class="mad-product-calc">
                        <span class="mad-product-price">10.000</span>
                  ...
                  <div class="mad-col">
                   ...
                   <div class="mad-product">
                      <figure class="mad-product-image">
                        <img src="img/comida/doble-pollo1.png" alt="">
                      </figure>
                      <!-- product-desc -->
                      <div class="mad-product-description">
                        <h4 class="mad-product-title">Burger Pollo doble</h4>
                        <p>250gr pollo, verduras, salsas de la casa, queso americano, papas.</p>
                      </div>
                      <!--/ product-desc -->
                      <div class="mad-product-calc">
                        <span class="mad-product-price">16.000</span>
                  ...
                  <div class="mad-col">
                    ...
                    <div class="mad-product">
                    <figure class="mad-product-image">
                        <img src="img/comida/burger_triple.png" alt="">
                      </figure>
                      <!-- product-desc -->
                      <div class="mad-product-description">
                        <h4 class="mad-product-title">Burger triple bacon</h4>
                        <p>Triple carne o pollo, verduras, salsas de la casa,salsa bbq, tocineta, queso mozarella, tocineta, queso americano</p>
                      </div>
                      <!--/ product-desc -->
                      <div class="mad-product-calc">
                  ...
                  <div class="mad-col">
                   ...
                   <div class="mad-product">
                      <figure class="mad-product-image">
                        <img src="img/comida/super-bbq1.png" alt="">
                      </figure>
                      <!-- product-desc -->
                      <div class="mad-product-description">
                        <h4 class="mad-product-title">Super Burger BBQ</h4>
                        <p>750gr carne o pollo, verduras, salsas de la casa,salsa bbq, tocineta, queso mozarella, tocineta, queso americano, papas.</p>
                      </div>
                      <!--/ product-desc -->
                      <div class="mad-product-calc">
                        <span class="mad-product-price">26.000</span>
                        <!-- <a href="ssencilla.php" class="btn btn-style-3 btn-small">Seleccionar</a> -->
                      </div>
                    </div>
                    <!-- End of Product -->
                  </div>
                ...
                <ul class="mad-pagination justify-content-center">
                    ...
                    <li><a href="salchipapa.php" class="prev mad-arrows"><img src="yummi_svg_icons/arrow_left.svg" alt="" class="svg"></a></li>
                    <li><a href="salchipapa.php" class="page-numbers">1</a></li>
