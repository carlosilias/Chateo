        ...
        <div class="mad-header-items">
          ...
          <nav class="mad-navigation-container">
            <ul class="mad-navigation mad-navigation--vertical-sm">
              ...
              <li class="menu-item menu-item-has-children current-menu-item"><a href="ubicacion.php">Ubicación</a></li>
              <li class="menu-item menu-item-has-children"><a href="contacto.php">Contácto</a></li>
        ...
        <div class="container">
          <div class="mad-section mad-section--stretched mad-colorizer--scheme-color-2">
            <div class="row hr-size-2">
              ...
              <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d7835.227488352755!2d-74.82302072384621!3d10.91693125360015!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x8ef5d2f9055ed2bb%3A0xe85069deb851488f!2sLos%20Almendros%2C%20Soledad%2C%20Atlantico!5e0!3m2!1sen!2sco!4v1658523733570!5m2!1sen!2sco" 
                width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
              </div>
              </div>
              <div class="col-xl-4 col-lg-5">
                <h2 class="mad-page-title">Chateo Fast Food</h2>
                <div class="content-element-4">
                  <div class="mad-our-info size-2 vr-type">
                    <div class="mad-info"><i class="material-icons-outlined">location_on</i> <span>Calle 84 # 126-05 Los Almendros<br> 
                        <br></span></div>
                    ...
                    <div class="mad-info"><i class="material-icons">mail_outline</i> <a href="#"
                        class="mad-link color-2">Chateo@gmail.com</a>
                    </div>
          ...
          <!-- <div class="mad-section">
            <div class="row justify-content-center">
              <div class="col-xl-6">
                <h2 class="align-center">Get in Touch With Us</h2>
                <p class="align-center">If you have any further enquiries, please use the form below.</p>
                <form class="mad-contact-form type-2">
                  <div class="mad-col">
                  ...
                  <div class="mad-col">
                    <input type="tel" id="cf_phone" name="cf_phone" required placeholder="Phone number (optional)">
                  </div>
                  <div class="mad-col">
                    <textarea rows="4" id="message" name="cf_message" required placeholder="Message"></textarea>
                  </div>
                  <div class="mad-col align-center">
                    <button type="submit" class="btn btn-big btn-style-3"><span>Submit</span></button>
                  </div>
                </form>
              </div>
            </div>
