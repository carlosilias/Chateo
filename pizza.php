            ...
            <div class="row hr-size-2 vr-size-2">
              <main id="main" class="col-xl-9">
                ...
                <div class="mad-products item-col-3">
                  ...
                  <div class="mad-col">
                    ...
                    <div class="mad-product">
                      ...
                      <!-- product-desc -->
                      <div class="mad-product-description">
                        <h4 class="mad-product-title">Pizza peperoni</a></h4>
                        <p>Pizza con toping de peperoni</p>
                      </div>
                      <!--/ product-desc -->
                      <div class="mad-product-calc">
                        <span class="mad-product-price">24.000</span>
                  ...
                  <div class="mad-col">
                   ...
                   <div class="mad-product">
                      <figure class="mad-product-image">
                        <img src="img/comida/pizza_pollo1.png" alt="">
                      </figure>
                      <!-- product-desc -->
                      <div class="mad-product-description">
                        <h4 class="mad-product-title">Pizza pollo o carne</h4>
                        <p>Pizza con toping de pollo o carne</p>
                      </div>
                      <!--/ product-desc -->
                      <div class="mad-product-calc">
                        <span class="mad-product-price">25.000</span>
                  ...
                  <div class="mad-product">
                      <figure class="mad-product-image">
                        <a href="ssencilla.php"><img src="img/comida/pizza_cham1.png" alt=""></a>
                      </figure>
                      <!-- product-desc -->
                      <div class="mad-product-description">
                        <h4 class="mad-product-title">Pizza champiñones</h4>
                        <p>Pizza con toping de champiñones</p>
                      </div>
                      <!--/ product-desc -->
                      <div class="mad-product-calc">
                        <span class="mad-product-price">24.000</span>
                  ...
                  <div class="mad-product">
                      <figure class="mad-product-image">
                        <img src="img/comida/pizza_cham-pollo1.png" alt="">
                      </figure>
                      <!-- product-desc -->
                      <div class="mad-product-description">
                        <h4 class="mad-product-title">Pizza champiñones y pollo</h4>
                        <p>Pizza con toping de champiñones y pollo</p>
                      </div>
                      <!--/ product-desc -->
                      <div class="mad-product-calc">
                        <span class="mad-product-price">24.000</span>
                  ...
                  <div class="mad-product">
                      <figure class="mad-product-image">
                       <img src="img/comida/pizza_carpollo1.png" alt="">
                      </figure>
                      <!-- product-desc -->
                      <div class="mad-product-description">
                        <h4 class="mad-product-title">Pizza carne y pollo</h4>
                        <p>Pizza con toping de carne y pollo</p>
                      </div>
                      <!--/ product-desc -->
                      <div class="mad-product-calc">
                        <span class="mad-product-price">27.000</span>
                ...
                <ul class="mad-pagination justify-content-center">
                  ...
                  <li><a href="salchipapa.php" class="next mad-arrows"><img src="yummi_svg_icons/arrow_right.svg" alt="" class="svg"></a></li>
