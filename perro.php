...
<!-- Mirrored from velikorodnov.com/html/yummi/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 31 Jan 2022 20:59:48 GMT -->
<head>
  <!--================ Basic page needs ================-->
...
<body>
  ...
  <div id="mad-page-wrapper" class="mad-page-wrapper">
        ...
        <div class="mad-header-items">
          ...
          <nav class="mad-navigation-container">
            <ul class="mad-navigation mad-navigation--vertical-sm">
              ...
              <li class="menu-item menu-item-has-children current-menu-item"><a href="salchipapa.php">Menu</a></li>
      ...
      <div class="mad-content no-pd">
        <div class="container">        
          ...
          <center><h2 class="mad-page-title">Menu</h2></center>
            <div class="row hr-size-2 vr-size-2">
              <main id="main" class="col-xl-9">
                ...
                <div class="product-sort-section">
                  <div class="mad-col">
                    <span>Mostrando 1–12 de 36 resultados</span>
                  </div>
                  <div class="mad-col">
                    <div class="mad-custom-select size-2">
                      <select data-default-text="Default sorting">
                        <option ><a href="index.php">Option 1</a> </option>
                ...
                <div class="mad-products item-col-3">
                  ...
                  <div class="mad-col">
                   ...
                   <div class="mad-product">
                      <figure class="mad-product-image">
                        <img src="img/comida/perro_gemelo1.png" alt="">
                      </figure>
                      <!-- product-desc -->
                      <div class="mad-product-description">
                        <h4 class="mad-product-title">Perro gemelo</h4>
                        <p>Doble Salchicha sencilla, papas chongo, salsas de la casa, verduras</p>
                      </div>
                      <!--/ product-desc -->
                      <div class="mad-product-calc">
                        <span class="mad-product-price">6.000</span>
                  ...
                  <div class="mad-col">
                    ...
                    <div class="mad-product">
                      ...
                      <!--/ product-desc -->
                      <div class="mad-product-calc">
                        <span class="mad-product-price">9.000</span>
                  ...
                  <div class="mad-col">
                   ...
                   <div class="mad-product">
                      <figure class="mad-product-image">
                        <img src="img/comida/perro_italiano1.png" alt="">
                      </figure>
                      <!-- product-desc -->
                      <div class="mad-product-description">
                        <h4 class="mad-product-title">Perro Italiano</h4>
                        <p>Perro caliente con salchicha, papas chongo, queso mozarella, tocineta, lechuga y salsa tartara.</p>
                      </div>
                      <!--/ product-desc -->
                      <div class="mad-product-calc">
                        <span class="mad-product-price">12.000</span>
                  ...
                  <div class="mad-col">
                   ...
                   <div class="mad-product">
                      <figure class="mad-product-image">
                        <img src="img/comida/perro_hawai.png" alt="">
                      </figure>
                      <!-- product-desc -->
                      <div class="mad-product-description">
                        <h4 class="mad-product-title">Perro Hawaiano</h4>
                        <p>Perro caliente con salchicha, papas de perro, salsa hawaiana tocineta, lechuga y salsa tartara.</p>
                      </div>
                      <!--/ product-desc -->
                      <div class="mad-product-calc">
                        <span class="mad-product-price">12.000</span>
                  ...
                  <div class="mad-col">
                   ...
                   <div class="mad-product">
                      <figure class="mad-product-image">
                        <img src="img/comida/super_perro1.png" alt="">
                      </figure>
                      <!-- product-desc -->
                      <div class="mad-product-description">
                        <h4 class="mad-product-title"><a href="ssencilla.php" class="mad-link">Super Perro</a></h4>
                        <p>Perro caliente con suiza, papas de perro,mozarella, Pollo,tocineta, lechuga y salsa tartara.</p>
                      </div>
                      <!--/ product-desc -->
                      <div class="mad-product-calc">
                        <span class="mad-product-price">18.000</span>
            ...
            <li><a href="perro.php" class="page-numbers">1</a></li>
            ...
            <li><a href="pizza.php" class="next mad-arrows"><img src="yummi_svg_icons/arrow_right.svg" alt="" class="svg"></a></li>
              ...
              <div class="mad-widget mad-categories">
                  <h5 class="mad-widget-title">Categorias</h5>
                  <div class=" ">
                    <ul>
                      <li><a href="salchipapa.php"><img src="img/iconos/french_fries2.svg" alt="" class="svg"><span>Salchipapa</span></a></li>                  
                      <li><a href="burger.php"><img src="img/iconos/burger2.svg" alt="" class="svg"><span>Hamburgesa</span></a></li>
                      <li><a href="perro.php"><img src="img/iconos/perro.png" alt="" class="svg"><span>Perros</span></a></li>
                      <li><a href="pizza.php"><img src="img/iconos/pizza2.svg" alt="" class="svg"><span>Pizza</span></a></li>                         
                    </ul>
                  </div>
                </div>
          ...
          <div class="row vr-size-1">
            <div class="col-lg-6">
              ...
              <section class="mad-widget">
                ...
                <div class="mad-our-info vr-type">
                  ...
                  <div class="mad-info"><i class="material-icons">mail_outline</i> <a href="#"
                      class="mad-link">Chateo@gmail.com</a></div>
              ...
              <section class="mad-widget">
                ...
                <div class="mad-vr-list">
                  <ul>
                    ...
                    <li><a href="#" class="mad-link">Hamburgesa</a></li>
                    <li><a href="#" class="mad-link">Salchipapa</a></li>
                    <li><a href="#" class="mad-link">Perros</a></li>
                  </ul>
                </div>
              </section>
              <!--================ End of Widget ================-->
            ...
            <div class="col-lg-2">
              ...
              <section class="mad-widget">
                ...
                <div class="mad-vr-list">
                  <ul>
                    <li><a href="#" class="mad-link">Inicio</a></li>
                    <li><a href="#" class="mad-link">Menu</a></li>
                    <li><a href="#" class="mad-link">Contacto</a></li>
                    <li><a href="#" class="mad-link">Ubicación</a></li>
    ...
    <button class="mad-back-to-top animated stealthy">
      <span class="icon">
      <img class="svg" src="yummi_svg_icons/arrow_right.svg" alt="">
    </span></button>
...
<!-- Mirrored from velikorodnov.com/html/yummi/shop_front_sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 May 2022 16:15:47 GMT -->
</html>
